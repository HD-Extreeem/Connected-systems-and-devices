 ...
 * Updated : $Date: 2005/06/08 20:23:24 $
 *           $Revision: 1.5 $
 */
...
public abstract class TransportWriter {
  ...
  /**
   * Notify the writer that this string value should be regarded as a
   * constant that probably will be used many times. The implementation
   * might use this for optimization.
   *
   * @param constant the value that should be regarded as a constant.
   */
