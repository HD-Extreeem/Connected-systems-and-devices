 ...
 * Updated : $Date: 2003/05/16 12:19:46 $
 *           $Revision: 1.8 $
 */
...
/**
 * <code>AgentService</code> is the abstract base class for the agent
 * service used by {@link Agent} to communicate with the SCM servers
 * (not used directly by agent implementations).
 */
public abstract class AgentService {
  ...
  // Should this be protected or package protected??? FIX THIS!!!
